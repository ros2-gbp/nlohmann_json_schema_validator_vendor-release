...
%global pkg_name nlohmann_json_schema_validator_vendor
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-nlohmann-json-schema-validator-vendor
Version:        0.6.1
Release:        1%{?dist}
...
%changelog
* Fri Sep 18 2026 Grey <grey@openrobotics.org> - 0.6.1-1
